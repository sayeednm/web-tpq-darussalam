...
export default function Keunggulan() {
  return (
    <section id="keunggulan" className="relative py-20 overflow-hidden bg-gray-50">
      {/* Dekorasi sudut */}
      <div className="absolute top-0 left-0 w-72 h-72 bg-emerald-100 rounded-full opacity-60 blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-amber-100 rounded-full opacity-60 blur-3xl translate-x-1/3 translate-y-1/3"></div>
